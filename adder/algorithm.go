...
func (d *AdderDistiller) LeadNanos() int64 {
	return 0
}
...
func (d *AdderDistiller) Rebase() distil.Rebaser {
...
func (d *AdderDistiller) Process(in *distil.InputSet, out *distil.OutputSet) {
